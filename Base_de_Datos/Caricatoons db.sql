...
CREATE TABLE `tbb_anime` (
  ...
  `Rating_total` decimal(5,2) DEFAULT '0.00',
...
INSERT INTO `tbb_anime` VALUES (1,'Gintama',367,'Terminado','Sunrise','Shinji Takamatsu','2006-04-04','2018-03-25',0.00,11,'Gintama es una serie de anime japonesa basada en el manga escrito e ilustrado por Hideaki Sorachi. La historia se desarrolla en una versión alternativa de la era Edo, donde la Tierra ha sido invadida por extraterrestres conocidos como \"Amanto\". Como resultado de la invasión, los samuráis han sido despojados de sus espadas, y Japón ha experimentado una transformación cultural significativa.','TV',_binary '','2023-07-23 01:51:33','2023-08-17 15:40:03'),(2,'One Piece',1053,'Emision','	Toei Animation','Kōnosuke Uda','1999-10-20',NULL,0.00,20,'Monkey D. Luffy es un muchacho que se hace a la mar para convertirse en pirata, y reunir una tripulación en su viaje de la búsqueda del One Piece, tesoro que quien lo encuentre se convertirá en el nuevo Rey de los Piratas.','TV',_binary '','2023-07-23 01:59:05','2023-08-17 15:40:03'),(3,'Yuri!!! on ice',12,'Terminado','MAPPA','Sayo Yamamoto','2016-10-06','2016-12-22',0.00,1,'Yuuri Katsuki, es un patinador artístico que, asumiendo las expectativas de todo Japón, experimentó una derrota aplastante en la final de Grand Prix,quedando último en la competición.. Con esto, él vuelve a su ciudad natal,en Kyushuu; sus sentimientos se debaten entre seguir patinando o retirarse.Yuri se dirige a una pista de patinaje donde imita a la perfección una coreografía del famoso patinador ruso Victor Nikiforov, a quien admira desde pequeño. Cuando el video de Yuri patinando es subido al internet sin su conocimiento, atrae la atención de Victor, quien decide convertirse en el entrenador de Yuri.','TV',_binary '','2023-07-23 03:22:05','2023-08-17 15:40:03'),(4,'Jujutsu Kaisen',47,'Emision','MAPPA','	Park Sung-hoo','2020-10-03',NULL,0.00,2,'Las emociones negativas creadas por los humanos se convierten en maldiciones y se esconden en la vida cotidiana. Las maldiciones son una fuerte epidemia en el mundo y, en el peor de los casos, lleva a los humanos a la muerte. Estas maldiciones solo pueden ser exorcizadas.','TV',_binary '','2023-07-23 03:29:04','2023-08-17 15:40:03'),(5,'Kimetsu no Yaiba',55,'Terminado','Ufotable','	Haruo Sotozaki','2018-04-06','2023-07-18',0.00,3,'La serie narra las desventuras de Tanjiro, un joven de un Japón feudal fantástico que se ve abocado a la venganza después de que un demonio acabe con toda su familia, a excepción de su hermana, Nezuko, también demoníaca y sedienta de sangre. El muchacho entrenará hasta convertirse en cazador de demonios, primero, en busca del culpable de la masacre, pero, sobre todo, para intentar revertir lo ocurrido con su hermana y volver a hacerla humana.','TV',_binary '','2023-07-23 03:35:35','2023-08-17 15:40:03'),(6,'JoJo\'s Bizarre Adventure',190,'Terminado','David Production','Naokatsu Tsuda','1993-11-19','2022-12-01',0.00,5,'Basado en el manga homónimo, Jojo\'s Bizarre Adventure sigue las aventuras de todas las generaciones de la familia Joestar, desde finales del siglo XIX hasta la actualidad. Todos los miembros de la familia tienen poderes, que son una fuerza psíquica intensa. Esta familia son los encargados de terminar con los enemigos sobrenaturales que amenazan el mundo. Además, la ficción narra todas las historias que se encuentra la familia a lo largo de sus aventuras.\r ','TV',_binary '','2023-07-23 03:41:20','2023-08-17 15:40:03'),(7,'Naruto',220,'Terminado','Pierrot','Hayato Date','2002-10-03','2007-02-08',0.00,5,'Naruto es un joven ninja que busca ser reconocido como el mejor ninja en su aldea y convertirse en Hokage.','TV',_binary '','2023-08-04 12:17:38','2023-08-17 15:40:03'),(8,'Hunter x Hunter',148,'Terminado','Madhouse','Hiroshi Koujina','2011-10-02','2014-09-24',0.00,3,'Gon Freecss se convierte en un cazador para encontrar a su padre y descubre un mundo lleno de peligros y desafíos.','TV',_binary '','2023-08-04 12:23:56','2023-08-17 15:40:03'),(9,'Steins;Gate',24,'Terminado','White Fox','Hiroshi Hamasaki','2011-04-06','2011-09-14',0.00,1,'Un grupo de amigos accidentalmente descubre una forma de enviar mensajes al pasado, lo que desencadena una serie de eventos catastróficos.','TV',_binary '','2023-08-04 12:23:56','2023-08-17 15:40:03'),(10,'Cowboy Bebop',26,'Terminado','Sunrise','Shinichirō Watanabe','1998-04-03','1999-04-24',0.00,1,'Spike Spiegel y su tripulación de cazarrecompensas viajan por el espacio persiguiendo a criminales peligrosos.','TV',_binary '','2023-08-04 12:23:56','2023-08-17 15:40:03'),(11,'Neon Genesis Evangelion',26,'Terminado','Gainax','Hideaki Anno','1995-10-04','1996-03-27',0.00,1,'En un mundo asolado por criaturas llamadas \"Ángeles\", jóvenes pilotos luchan usando mechas gigantes para proteger la humanidad.','TV',_binary '','2023-08-04 12:23:56','2023-08-17 15:40:03'),(12,'My Teen Romantic Comedy SNAFU',26,'Terminado','Brain\'s Base','Ai Yoshimura','2013-04-05','2013-06-28',0.00,1,'Hachiman Hikigaya, un estudiante cínico, se une al club de servicios voluntarios donde su perspectiva de la vida comienza a cambiar.','TV',_binary '','2023-08-04 12:23:56','2023-08-17 15:40:03'),(13,'Clannad',23,'Terminado','Kyoto Animation','Tatsuya Ishihara','2007-10-04','2008-03-27',0.00,1,'Tomoya Okazaki forma lazos con varias chicas en su escuela mientras enfrenta desafíos personales y familiares.','TV',_binary '','2023-08-04 12:23:56','2023-08-17 15:40:03'),(14,'Fairy Tail',328,'Terminado','A-1 Pictures','Shinji Ishihira','2009-10-12','2019-09-29',0.00,9,'Natsu Dragneel y su gremio mágico Fairy Tail realizan misiones y enfrentan amenazas en el mundo mágico de Fiore.','TV',_binary '','2023-08-04 12:23:56','2023-08-17 15:40:03'),(15,'Black Clover',170,'Emision','Pierrot','Tatsuya Yoshihara','2017-10-03',NULL,0.00,1,'Asta y Yuno luchan por convertirse en el Mago Rey en un mundo donde la magia lo es todo.','TV',_binary '','2023-08-04 12:23:56','2023-08-17 15:40:03'),(16,'Demon Slayer',26,'Terminado','ufotable','Haruo Sotozaki','2019-04-06','2019-09-28',0.00,1,'Tanjiro Kamado se convierte en un cazador de demonios después de que su familia sea masacrada y su hermana se convierta en un demonio.','TV',_binary '','2023-08-04 12:23:56','2023-08-17 15:40:03'),(17,'Haikyuu!!',85,'Terminado','Production I.G','Susumu Mitsunaka','2014-04-06','2016-03-26',0.00,3,'Un equipo de voleibol de preparatoria lucha por alcanzar el campeonato nacional, superando desafíos y mejorando sus habilidades.','TV',_binary '','2023-08-04 12:25:18','2023-08-17 15:40:03'),(18,'No Game No Life',12,'Terminado','Madhouse','Atsuko Ishizuka','2014-04-09','2014-06-25',0.00,1,'Dos hermanos gamers son transportados a un mundo de juegos de alto riesgo, donde deben usar su ingenio para sobrevivir.','TV',_binary '','2023-08-04 12:25:18','2023-08-17 15:40:03'),(19,'Tokyo Revengers',24,'Emision','LIDENFILMS','Koichi Hatsumi','2021-04-11',NULL,0.00,1,'Un joven descubre que puede viajar en el tiempo a su pasado de gángsters de secundaria y se propone cambiar el curso de la historia.','TV',_binary '','2023-08-04 12:25:18','2023-08-17 15:40:03'),(20,'Vinland Saga',24,'Emision','Wit Studio','Shuhei Yabuta','2019-07-07',NULL,0.00,1,'Thorfinn, un joven vikingo, busca vengar la muerte de su padre y se involucra en las luchas por el poder en Inglaterra.','TV',_binary '','2023-08-04 12:25:18','2023-08-17 15:40:03'),(21,'The Promised Neverland',24,'Terminado','CloverWorks','Mamoru Kanbe','2019-01-09','2019-03-29',0.00,1,'Emma y sus amigos intentan escapar de un orfanato después de descubrir un oscuro secreto sobre su verdadero propósito.','TV',_binary '','2023-08-04 12:25:18','2023-08-17 15:40:03'),(22,'Dr. Stone',48,'Emision','TMS Entertainment','Shinya Iino','2019-07-05',NULL,0.00,1,'Después de que un misterioso fenómeno convierta a la humanidad en piedra, un científico despierta miles de años después y trabaja para reconstruir la civilización.','TV',_binary '','2023-08-04 12:25:18','2023-08-17 15:40:03'),(23,'Mob Psycho 100',25,'Terminado','Bones','Yuzuru Tachikawa','2016-07-11','2016-09-27',0.00,1,'Un estudiante con habilidades psíquicas poderosas lucha por controlar sus emociones y descubre el significado de ser fuerte.','TV',_binary '','2023-08-04 12:25:18','2023-08-17 15:40:03'),(24,'Re:Zero - Starting Life in Another World',50,'Emision','White Fox','Masaharu Watanabe','2016-04-04',NULL,0.00,1,'Subaru Natsuki es transportado a un mundo de fantasía y descubre que puede volver a la vida cada vez que muere, pero no sin consecuencias.','TV',_binary '','2023-08-04 12:25:18','2023-08-17 15:40:03'),(25,'One Punch Man',24,'Emision','Madhouse','Shingo Natsume','2015-10-04',NULL,0.00,1,'Saitama puede derrotar a cualquier enemigo con un solo golpe, pero se siente aburrido y busca un desafío verdadero.','TV',_binary '','2023-08-04 12:25:18','2023-08-17 15:40:03'),(26,'The Rising of the Shield Hero',25,'Terminado','Kinema Citrus','Takao Abo','2019-01-09','2019-06-26',0.00,1,'Nanatsu es convocado a un mundo de fantasía como el Héroe del Escudo, pero se encuentra despreciado y debe luchar para ganarse el respeto.','TV',_binary '','2023-08-04 12:25:18','2023-08-17 15:40:03'),(27,'Parasyte -the maxim-',24,'Terminado','Madhouse','Kenichi Shimizu','2014-10-09','2015-03-26',0.00,1,'Un estudiante de secundaria lucha contra parásitos alienígenas que toman control de los humanos y se alimentan de otros.','TV',_binary '','2023-08-04 12:28:24','2023-08-17 15:40:03'),(28,'Soul Eater',51,'Terminado','Bones','Takuya Igarashi','2008-04-07','2009-03-30',0.00,1,'Estudiantes de una escuela especial luchan contra criaturas y seres malvados para recolectar almas y mantener el equilibrio del mundo.','TV',_binary '','2023-08-04 12:28:24','2023-08-17 15:40:03'),(29,'Magi: The Labyrinth of Magic',25,'Terminado','A-1 Pictures','Koji Masunari','2012-10-07','2013-03-31',0.00,1,'Aladdin y sus amigos se embarcan en aventuras mágicas en un mundo lleno de misterio, tesoros y peligros.','TV',_binary '','2023-08-04 12:28:24','2023-08-17 15:40:03'),(30,'Bakuman',75,'Terminado','J.C. Staff','Kenichi Kasai','2010-10-02','2013-03-30',0.00,3,'Dos estudiantes de secundaria aspiran a convertirse en mangakas exitosos y enfrentan desafíos en la industria del manga.','TV',_binary '','2023-08-04 12:28:24','2023-08-17 15:40:03'),(31,'Tokyo Ghoul',48,'Terminado','Pierrot','Shuhei Morita','2014-07-04','2014-09-19',0.00,1,'Un estudiante universitario se convierte en mitad ghoul después de un encuentro cercano con uno de estos devoradores de carne humana.','TV',_binary '','2023-08-04 12:28:24','2023-08-17 15:40:03'),(32,'Durarara!!',60,'Terminado','Brain\'s Base','Takahiro Omori','2010-01-08','2010-12-25',0.00,2,'Varias historias entrelazadas revelan las vidas y secretos de habitantes en el peligroso distrito de Ikebukuro en Tokio.','TV',_binary '','2023-08-04 12:28:24','2023-08-17 15:40:03'),(33,'Made in Abyss',13,'Terminado','Kinema Citrus','Masayuki Kojima','2017-07-07','2017-09-29',0.00,1,'Riko, una joven exploradora, desciende en el Abismo en busca de su madre y enfrenta desafíos mortales en este mundo misterioso.','TV',_binary '','2023-08-04 12:28:24','2023-08-17 15:40:03'),(34,'Promare',1,'Terminado','Trigger','Hiroyuki Imaishi','2019-05-24',NULL,0.00,1,'Un grupo de bomberos especiales lucha contra mutantes incendiarios en una sociedad futurista en este anime de película.','Pelicula',_binary '','2023-08-04 12:28:24','2023-08-17 15:40:03'),(35,'Banana Fish',24,'Terminado','MAPPA','Hiroko Utsumi','2018-07-06','2018-12-21',0.00,1,'Un joven líder de pandilla en Nueva York se ve envuelto en un misterio relacionado con una droga llamada \"Banana Fish\".','TV',_binary '','2023-08-04 12:28:24','2023-08-17 15:40:03'),(36,'Devilman Crybaby',10,'Terminado','Science SARU','Masaaki Yuasa','2018-01-05','2018-03-21',0.00,1,'Akira Fudo se convierte en Devilman para luchar contra demonios y prevenir el apocalipsis en este reinicio moderno de la serie clásica.','TV',_binary '','2023-08-04 12:28:24','2023-08-17 15:40:03'),(37,'Dennou Coil',26,'Terminado','Madhouse','Mitsuo Iso','2007-05-12','2007-12-01',0.00,1,'En un futuro cercano, los niños usan gafas de realidad aumentada para interactuar con un mundo digital que oculta misterios sobrenaturales.','TV',_binary '','2023-08-04 12:34:39','2023-08-17 15:40:03'),(38,'Mushishi',26,'Terminado','Artland','Hiroshi Nagahama','2005-10-23','2006-06-19',0.00,1,'Ginko viaja para investigar los \"Mushi\", formas de vida primitivas que existen en armonía con la naturaleza, pero que a veces causan problemas a los humanos.','TV',_binary '','2023-08-04 12:34:39','2023-08-17 15:40:03'),(39,'Haibane Renmei',13,'Terminado','Radix Ace Entertainment','Tomokazu Tokoro','2002-10-09','2002-12-18',0.00,1,'Rakka despierta como un \"Haibane\", un ser alado con halo, en un mundo misterioso rodeado por un muro.','TV',_binary '','2023-08-04 12:34:39','2023-08-17 15:40:03'),(40,'Bakemonogatari',15,'Terminado','Shaft','Akiyuki Shinbo','2009-07-03','2009-09-25',0.00,1,'Koyomi Araragi ayuda a varias chicas con problemas sobrenaturales mientras investiga su propia maldición de vampiro.','TV',_binary '','2023-08-04 12:34:39','2023-08-17 15:40:03'),(41,'Kino\'s Journey',13,'Terminado','A.C.G.T.','Ryutaro Nakamura','2003-04-08','2003-07-08',0.00,1,'Kino viaja en su motocicleta parlante Hermes, explorando diferentes países y culturas en cada lugar que visita.','TV',_binary '','2023-08-04 12:34:39','2023-08-17 15:40:03'),(42,'Serial Experiments Lain',13,'Terminado','Triangle Staff','Ryutaro Nakamura','1998-07-06','1998-09-28',0.00,1,'Lain descubre un mundo virtual llamado \"The Wired\" y comienza a perder la distinción entre la realidad y la realidad virtual.','TV',_binary '','2023-08-04 12:34:39','2023-08-17 15:40:03'),(43,'Texhnolyze',22,'Terminado','Madhouse','Hiroshi Hamazaki','2003-04-17','2003-09-25',0.00,1,'En una ciudad subterránea sombría, un hombre llamado Ichise se ve envuelto en una lucha de poder entre facciones criminales y religiosas.','TV',_binary '','2023-08-04 12:34:39','2023-08-17 15:40:03'),(44,'Kemono no Souja Erin',50,'Terminado','Production I.G','Satoshi Nishimura','2009-01-10','2009-12-26',0.00,1,'Erin criada en un pueblo que entrena bestias para el rey, descubre secretos y desafíos mientras busca su lugar en un mundo lleno de misterios.','TV',_binary '','2023-08-04 12:34:39','2023-08-17 15:40:03'),(45,'Kaiba',12,'Terminado','Madhouse','Masaaki Yuasa','2008-04-10','2008-07-24',0.00,1,'En un mundo donde las memorias pueden ser almacenadas y transferidas, un hombre despierta sin su memoria y se embarca en un viaje para recuperarla.','TV',_binary '','2023-08-04 12:34:39','2023-08-17 15:40:03'),(46,'RahXephon',26,'Terminado','Bones','Yutaka Izubuchi','2002-01-21','2002-09-10',0.00,1,'Ayato Kamina descubre un mecha misterioso y se ve involucrado en una lucha contra una raza alienígena en un mundo donde la realidad y los sueños se entrelazan.','TV',_binary '','2023-08-04 12:34:39','2023-08-17 15:40:03'),(47,'FLCL',6,'Terminado','Gainax','Kazuya Tsurumaki','2000-04-26',NULL,0.00,1,'Naota Nandaba, un joven de doce años, vive en una ciudad aparentemente normal hasta que su vida da un giro inesperado con la llegada de Haruko Haruhara en su peculiar Vespa y una guitarra con forma de arma de fuego.','Ova',_binary '','2023-08-04 12:36:42','2023-08-17 15:40:03'),(48,'Black Lagoon: Roberta\'s Blood Trail',5,'Terminado','Madhouse','Sunao Katabuchi','2010-07-17',NULL,0.00,1,'La empleada doméstica asesina Roberta, conocida como \"La Poderosa\", regresa a Roanapur en busca de venganza. Los protagonistas de Black Lagoon se ven atrapados en una letal confrontación de la mafia.','Ova',_binary '','2023-08-04 12:36:42','2023-08-17 15:40:03'),(49,'Hellsing Ultimate',10,'Terminado','Satelight','Hiroyuki Tanaka','2006-02-10',NULL,0.00,1,'La Organización Hellsing se enfrenta a amenazas sobrenaturales y fuerzas malignas, mientras el vampiro Alucard lucha contra enemigos que desafían la humanidad.','Ova',_binary '','2023-08-04 12:36:42','2023-08-17 15:40:03'),(50,'Rurouni Kenshin: Trust & Betrayal',4,'Terminado','Studio Deen','Kazuhito Kikuchi','1999-02-20',NULL,0.00,1,'Esta precuela de Rurouni Kenshin narra el pasado de Kenshin Himura cuando era un asesino conocido como \"Battousai el Destajador\". La historia sigue sus luchas y su transformación en un espadachín errante en busca de redención.','Ova',_binary '','2023-08-04 12:36:42','2023-08-17 15:40:03'),(51,'Akira',1,'Terminado','Tokyo Movie Shinsha','Katsuhiro Otomo','1988-07-16',NULL,0.00,1,'En una Neo-Tokio post-apocalíptica, un joven llamado Tetsuo obtiene poderes psíquicos después de un accidente en su motocicleta. Su amigo Kaneda intenta detenerlo antes de que cause una catástrofe.','Pelicula',_binary '','2023-08-04 12:38:12','2023-08-17 15:40:03'),(52,'Grave of the Fireflies',1,'Terminado','Studio Ghibli','Isao Takahata','1988-04-16',NULL,0.00,1,'Durante la Segunda Guerra Mundial, dos hermanos japoneses luchan por sobrevivir en medio del caos y la destrucción causados por los bombardeos aéreos.','Pelicula',_binary '','2023-08-04 12:38:12','2023-08-17 15:40:03'),(53,'Princess Mononoke',1,'Terminado','Studio Ghibli','Hayao Miyazaki','1997-07-12',NULL,0.00,1,'El príncipe Ashitaka se embarca en un viaje para encontrar una cura a una maldición mortal y se involucra en una lucha entre los humanos y los espíritus del bosque.','Pelicula',_binary '','2023-08-04 12:38:12','2023-08-17 15:40:03'),(54,'Paprika',1,'Terminado','Madhouse','Satoshi Kon','2006-11-25',NULL,0.00,1,'Un dispositivo experimental permite a los terapeutas entrar en los sueños de sus pacientes. Cuando el dispositivo es robado, la psicoterapeuta Atsuko Chiba se convierte en la enigmática Paprika para resolver el misterio.','Pelicula',_binary '','2023-08-04 12:38:12','2023-08-17 15:40:03'),(55,'The Girl Who Leapt Through Time',1,'Terminado','Madhouse','Mamoru Hosoda','2006-07-15',NULL,0.00,1,'Makoto Konno descubre que puede viajar en el tiempo y comienza a usar esta habilidad para cambiar su vida y la de sus amigos, pero pronto enfrenta las consecuencias.','Pelicula',_binary '','2023-08-04 12:38:12','2023-08-17 15:40:03'),(56,'Wolf Children',1,'Terminado','Studio Chizu','Mamoru Hosoda','2012-07-21',NULL,0.00,1,'Una joven llamada Hana se enamora de un hombre lobo y da a luz a dos hijos mitad humanos, mitad lobos. Después de la muerte de su esposo, Hana lucha por criar a sus hijos en un mundo que no los comprende.','Pelicula',_binary '','2023-08-04 12:38:12','2023-08-17 15:40:03'),(57,'A Silent Voice',1,'Terminado','Kyoto Animation','Naoko Yamada','2016-09-17',NULL,0.00,1,'Un joven intenta redimirse después de acosar a una compañera de clase sorda en esta conmovedora película.','Pelicula',_binary '','2023-08-04 12:38:12','2023-08-17 15:40:03'),(58,'Your Name',1,'Terminado','CoMix Wave Films','Makoto Shinkai','2016-08-26',NULL,0.00,1,'Mitsuha y Taki, dos desconocidos que intercambian cuerpos, buscan encontrarse en este hermoso drama romántico.','Pelicula',_binary '','2023-08-04 12:38:12','2023-08-17 15:40:03'),(59,'Weathering with You',1,'Terminado','CoMix Wave Films','Makoto Shinkai','2019-07-19',NULL,0.00,1,'Un adolescente huye a Tokio y se encuentra con una chica que puede controlar el clima, pero sus poderes tienen un alto costo.','Pelicula',_binary '','2023-08-04 12:38:12','2023-08-17 15:40:03'),(60,'A Whisker Away',1,'Terminado','Studio Colorido','Junichi Sato, Tomotaka Shibayama','2020-06-18',NULL,0.00,1,'Una chica se transforma en un gato para acercarse al chico que le gusta, pero descubre que esta nueva forma de vida no es tan sencilla como parece.','Pelicula',_binary '','2023-08-04 12:38:12','2023-08-17 15:40:03'),(61,'FLCL: Progressive',6,'Terminado','Production I.G','Kazuya Tsurumaki','2018-06-02',NULL,0.00,1,'Hidomi Hibajiri, una joven de secundaria con problemas, se ve envuelta en situaciones extrañas y encuentra una conexión con un ser extraterrestre.','Ova',_binary '','2023-08-04 12:40:37','2023-08-17 15:40:03'),(62,'FLCL: Alternative',6,'Terminado','Production I.G','Kazuya Tsurumaki','2018-09-07',NULL,0.00,1,'Kana Koumoto y sus amigos se encuentran en medio de una lucha entre robots gigantes y extraterrestres mientras enfrentan los desafíos de la adolescencia.','Ova',_binary '','2023-08-04 12:40:37','2023-08-17 15:40:03'),(63,'Tenchi Muyo! Ryo-Ohki',6,'Terminado','AIC','Hiroshi Negishi','1992-09-25',NULL,0.00,1,'Tenchi Masaki se ve envuelto en una batalla intergaláctica entre varias princesas espaciales mientras lidia con la presencia de chicas alienígenas en su vida.','Ova',_binary '','2023-08-04 12:40:37','2023-08-17 15:40:03'),(64,'Elfen Lied',1,'Terminado','Arms','Mamoru Kanbe','2005-04-21',NULL,0.00,1,'Esta OVA explora los eventos pasados y los sentimientos de Lucy en relación con el trágico mundo en el que vive.','Ova',_binary '','2023-08-04 12:40:37','2023-08-17 15:40:03'),(65,'Gunsmith Cats',3,'Terminado','Oriental Light and Magic','Kōichi Mashimo','1995-12-25',NULL,0.00,1,'Las hermanas Rally Vincent y Minnie-May Hopkins, propietarias de Gunsmith Cats, un taller de armas de fuego y cazarrecompensas, se involucran en situaciones peligrosas.','Ova',_binary '','2023-08-04 12:40:37','2023-08-17 15:40:03'),(66,'Macross Plus',4,'Terminado','Triangle Staff','Shoji Kawamori','1994-08-25',NULL,0.00,1,'En una rivalidad entre dos pilotos de mechas, Isamu Dyson y Guld Goa Bowman, se desentrañan secretos y tensiones en medio de un proyecto de desarrollo de inteligencia artificial.','Ova',_binary '','2023-08-04 12:40:37','2023-08-17 15:40:03'),(67,'Mobile Suit Gundam: The 08th MS Team',12,'Terminado','Sunrise','Takeyuki Kanda','1996-01-25',NULL,0.00,1,'En medio de la Guerra de un Año, el Equipo MS 08 lucha en la Tierra y en el espacio con unidades móviles y enfrenta desafíos tanto militares como personales.','Ova',_binary '','2023-08-04 12:40:37','2023-08-17 15:40:03'),(68,'Hellsing: The Dawn',3,'Terminado','Satelight','Ryoichi Koga','2011-07-27',NULL,0.00,1,'Esta precuela de Hellsing explora los orígenes de Alucard, Sir Integra Hellsing y Walter C. Dorneaz mientras enfrentan amenazas sobrenaturales.','Ova',_binary '','2023-08-04 12:40:37','2023-08-17 15:40:03'),(69,'Black Rock Shooter',1,'Terminado','Ordet, Sanzigen','Shinobu Yoshioka','2010-07-24',NULL,0.00,1,'Dos amigas, Mato Kuroi y Yomi Takanashi, luchan en un mundo de batalla surrealista como las versiones alter ego de la misteriosa Black Rock Shooter.','Ova',_binary '','2023-08-04 12:40:37','2023-08-17 15:40:03'),(70,'Gunbuster',6,'Terminado','Gainax','Hideaki Anno','1988-10-07',NULL,0.00,1,'Noriko Takaya y Kazumi Amano se entrenan para ser pilotos de mechas y defender a la humanidad contra una raza alienígena. La OVA explora su entrenamiento y sus luchas personales.','Ova',_binary '','2023-08-04 12:40:37','2023-08-17 15:40:03');
...
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `tr_create_rating` AFTER INSERT ON `tbc_rating` FOR EACH ROW BEGIN
      DECLARE v_total INT;
    DECLARE v_calificacion_a DECIMAL(5, 2);
    DECLARE v_calificacion_u DECIMAL(5,2);
    DECLARE V_nuevo_promedio DECIMAL(5, 2);

    -- Obtener el total de calificaciones y la suma de calificaciones para el usuario


    SET v_calificacion_a = 
    (SELECT Rating_total FROM tbb_anime where idAnime = NEW.Anime_id limit 1);

    SET v_calificacion_u = 
    (SELECT Calificacion FROM tbc_rating where Anime_id = NEW.Anime_id limit 1);


    SET v_total =
    (SELECT COUNT(*) FROM tbc_rating where Anime_id = NEW.Anime_id);


    -- Calcular el nuevo promedio
    
    IF v_total = 0 THEN
        SET V_nuevo_promedio = (v_calificacion_a + v_calificacion_u) / v_total;
    ELSE
        SET V_nuevo_promedio = v_calificacion_u;
    END IF;

    -- Actualizar el promedio en la tabla promedio_usuarios
    UPDATE tbb_anime
    SET `Rating_total` = V_nuevo_promedio 
    WHERE (`idAnime` = NEW.Anime_id);
...
INSERT INTO `tbi_bitacora` VALUES (3,'root@localhost','tbb_anime','Update','El usuario: root@localhost ha actualizado un ANIME con el ID: 1 con el NOMBRE: Gintama y FECHA DE ACTUALIZACIÓN: 2023-08-17 15:40:03','2023-08-17 15:40:03',_binary ''),(4,'root@localhost','tbb_anime','Update','El usuario: root@localhost ha actualizado un ANIME con el ID: 2 con el NOMBRE: One Piece y FECHA DE ACTUALIZACIÓN: 2023-08-17 15:40:03','2023-08-17 15:40:03',_binary ''),(5,'root@localhost','tbb_anime','Update','El usuario: root@localhost ha actualizado un ANIME con el ID: 3 con el NOMBRE: Yuri!!! on ice y FECHA DE ACTUALIZACIÓN: 2023-08-17 15:40:03','2023-08-17 15:40:03',_binary ''),(6,'root@localhost','tbb_anime','Update','El usuario: root@localhost ha actualizado un ANIME con el ID: 4 con el NOMBRE: Jujutsu Kaisen y FECHA DE ACTUALIZACIÓN: 2023-08-17 15:40:03','2023-08-17 15:40:03',_binary ''),(7,'root@localhost','tbb_anime','Update','El usuario: root@localhost ha actualizado un ANIME con el ID: 5 con el NOMBRE: Kimetsu no Yaiba y FECHA DE ACTUALIZACIÓN: 2023-08-17 15:40:03','2023-08-17 15:40:03',_binary ''),(8,'root@localhost','tbb_anime','Update','El usuario: root@localhost ha actualizado un ANIME con el ID: 6 con el NOMBRE: JoJo\'s Bizarre Adventure y FECHA DE ACTUALIZACIÓN: 2023-08-17 15:40:03','2023-08-17 15:40:03',_binary ''),(9,'root@localhost','tbb_anime','Update','El usuario: root@localhost ha actualizado un ANIME con el ID: 7 con el NOMBRE: Naruto y FECHA DE ACTUALIZACIÓN: 2023-08-17 15:40:03','2023-08-17 15:40:03',_binary ''),(10,'root@localhost','tbb_anime','Update','El usuario: root@localhost ha actualizado un ANIME con el ID: 8 con el NOMBRE: Hunter x Hunter y FECHA DE ACTUALIZACIÓN: 2023-08-17 15:40:03','2023-08-17 15:40:03',_binary ''),(11,'root@localhost','tbb_anime','Update','El usuario: root@localhost ha actualizado un ANIME con el ID: 9 con el NOMBRE: Steins;Gate y FECHA DE ACTUALIZACIÓN: 2023-08-17 15:40:03','2023-08-17 15:40:03',_binary ''),(12,'root@localhost','tbb_anime','Update','El usuario: root@localhost ha actualizado un ANIME con el ID: 10 con el NOMBRE: Cowboy Bebop y FECHA DE ACTUALIZACIÓN: 2023-08-17 15:40:03','2023-08-17 15:40:03',_binary ''),(13,'root@localhost','tbb_anime','Update','El usuario: root@localhost ha actualizado un ANIME con el ID: 11 con el NOMBRE: Neon Genesis Evangelion y FECHA DE ACTUALIZACIÓN: 2023-08-17 15:40:03','2023-08-17 15:40:03',_binary ''),(14,'root@localhost','tbb_anime','Update','El usuario: root@localhost ha actualizado un ANIME con el ID: 12 con el NOMBRE: My Teen Romantic Comedy SNAFU y FECHA DE ACTUALIZACIÓN: 2023-08-17 15:40:03','2023-08-17 15:40:03',_binary ''),(15,'root@localhost','tbb_anime','Update','El usuario: root@localhost ha actualizado un ANIME con el ID: 13 con el NOMBRE: Clannad y FECHA DE ACTUALIZACIÓN: 2023-08-17 15:40:03','2023-08-17 15:40:03',_binary ''),(16,'root@localhost','tbb_anime','Update','El usuario: root@localhost ha actualizado un ANIME con el ID: 14 con el NOMBRE: Fairy Tail y FECHA DE ACTUALIZACIÓN: 2023-08-17 15:40:03','2023-08-17 15:40:03',_binary ''),(17,'root@localhost','tbb_anime','Update','El usuario: root@localhost ha actualizado un ANIME con el ID: 15 con el NOMBRE: Black Clover y FECHA DE ACTUALIZACIÓN: 2023-08-17 15:40:03','2023-08-17 15:40:03',_binary ''),(18,'root@localhost','tbb_anime','Update','El usuario: root@localhost ha actualizado un ANIME con el ID: 16 con el NOMBRE: Demon Slayer y FECHA DE ACTUALIZACIÓN: 2023-08-17 15:40:03','2023-08-17 15:40:03',_binary ''),(19,'root@localhost','tbb_anime','Update','El usuario: root@localhost ha actualizado un ANIME con el ID: 17 con el NOMBRE: Haikyuu!! y FECHA DE ACTUALIZACIÓN: 2023-08-17 15:40:03','2023-08-17 15:40:03',_binary ''),(20,'root@localhost','tbb_anime','Update','El usuario: root@localhost ha actualizado un ANIME con el ID: 18 con el NOMBRE: No Game No Life y FECHA DE ACTUALIZACIÓN: 2023-08-17 15:40:03','2023-08-17 15:40:03',_binary ''),(21,'root@localhost','tbb_anime','Update','El usuario: root@localhost ha actualizado un ANIME con el ID: 19 con el NOMBRE: Tokyo Revengers y FECHA DE ACTUALIZACIÓN: 2023-08-17 15:40:03','2023-08-17 15:40:03',_binary ''),(22,'root@localhost','tbb_anime','Update','El usuario: root@localhost ha actualizado un ANIME con el ID: 20 con el NOMBRE: Vinland Saga y FECHA DE ACTUALIZACIÓN: 2023-08-17 15:40:03','2023-08-17 15:40:03',_binary ''),(23,'root@localhost','tbb_anime','Update','El usuario: root@localhost ha actualizado un ANIME con el ID: 21 con el NOMBRE: The Promised Neverland y FECHA DE ACTUALIZACIÓN: 2023-08-17 15:40:03','2023-08-17 15:40:03',_binary ''),(24,'root@localhost','tbb_anime','Update','El usuario: root@localhost ha actualizado un ANIME con el ID: 22 con el NOMBRE: Dr. Stone y FECHA DE ACTUALIZACIÓN: 2023-08-17 15:40:03','2023-08-17 15:40:03',_binary ''),(25,'root@localhost','tbb_anime','Update','El usuario: root@localhost ha actualizado un ANIME con el ID: 23 con el NOMBRE: Mob Psycho 100 y FECHA DE ACTUALIZACIÓN: 2023-08-17 15:40:03','2023-08-17 15:40:03',_binary ''),(26,'root@localhost','tbb_anime','Update','El usuario: root@localhost ha actualizado un ANIME con el ID: 24 con el NOMBRE: Re:Zero - Starting Life in Another World y FECHA DE ACTUALIZACIÓN: 2023-08-17 15:40:03','2023-08-17 15:40:03',_binary ''),(27,'root@localhost','tbb_anime','Update','El usuario: root@localhost ha actualizado un ANIME con el ID: 25 con el NOMBRE: One Punch Man y FECHA DE ACTUALIZACIÓN: 2023-08-17 15:40:03','2023-08-17 15:40:03',_binary ''),(28,'root@localhost','tbb_anime','Update','El usuario: root@localhost ha actualizado un ANIME con el ID: 26 con el NOMBRE: The Rising of the Shield Hero y FECHA DE ACTUALIZACIÓN: 2023-08-17 15:40:03','2023-08-17 15:40:03',_binary ''),(29,'root@localhost','tbb_anime','Update','El usuario: root@localhost ha actualizado un ANIME con el ID: 27 con el NOMBRE: Parasyte -the maxim- y FECHA DE ACTUALIZACIÓN: 2023-08-17 15:40:03','2023-08-17 15:40:03',_binary ''),(30,'root@localhost','tbb_anime','Update','El usuario: root@localhost ha actualizado un ANIME con el ID: 28 con el NOMBRE: Soul Eater y FECHA DE ACTUALIZACIÓN: 2023-08-17 15:40:03','2023-08-17 15:40:03',_binary ''),(31,'root@localhost','tbb_anime','Update','El usuario: root@localhost ha actualizado un ANIME con el ID: 29 con el NOMBRE: Magi: The Labyrinth of Magic y FECHA DE ACTUALIZACIÓN: 2023-08-17 15:40:03','2023-08-17 15:40:03',_binary ''),(32,'root@localhost','tbb_anime','Update','El usuario: root@localhost ha actualizado un ANIME con el ID: 30 con el NOMBRE: Bakuman y FECHA DE ACTUALIZACIÓN: 2023-08-17 15:40:03','2023-08-17 15:40:03',_binary ''),(33,'root@localhost','tbb_anime','Update','El usuario: root@localhost ha actualizado un ANIME con el ID: 31 con el NOMBRE: Tokyo Ghoul y FECHA DE ACTUALIZACIÓN: 2023-08-17 15:40:03','2023-08-17 15:40:03',_binary ''),(34,'root@localhost','tbb_anime','Update','El usuario: root@localhost ha actualizado un ANIME con el ID: 32 con el NOMBRE: Durarara!! y FECHA DE ACTUALIZACIÓN: 2023-08-17 15:40:03','2023-08-17 15:40:03',_binary ''),(35,'root@localhost','tbb_anime','Update','El usuario: root@localhost ha actualizado un ANIME con el ID: 33 con el NOMBRE: Made in Abyss y FECHA DE ACTUALIZACIÓN: 2023-08-17 15:40:03','2023-08-17 15:40:03',_binary ''),(36,'root@localhost','tbb_anime','Update','El usuario: root@localhost ha actualizado un ANIME con el ID: 34 con el NOMBRE: Promare y FECHA DE ACTUALIZACIÓN: 2023-08-17 15:40:03','2023-08-17 15:40:03',_binary ''),(37,'root@localhost','tbb_anime','Update','El usuario: root@localhost ha actualizado un ANIME con el ID: 35 con el NOMBRE: Banana Fish y FECHA DE ACTUALIZACIÓN: 2023-08-17 15:40:03','2023-08-17 15:40:03',_binary ''),(38,'root@localhost','tbb_anime','Update','El usuario: root@localhost ha actualizado un ANIME con el ID: 36 con el NOMBRE: Devilman Crybaby y FECHA DE ACTUALIZACIÓN: 2023-08-17 15:40:03','2023-08-17 15:40:03',_binary ''),(39,'root@localhost','tbb_anime','Update','El usuario: root@localhost ha actualizado un ANIME con el ID: 37 con el NOMBRE: Dennou Coil y FECHA DE ACTUALIZACIÓN: 2023-08-17 15:40:03','2023-08-17 15:40:03',_binary ''),(40,'root@localhost','tbb_anime','Update','El usuario: root@localhost ha actualizado un ANIME con el ID: 38 con el NOMBRE: Mushishi y FECHA DE ACTUALIZACIÓN: 2023-08-17 15:40:03','2023-08-17 15:40:03',_binary ''),(41,'root@localhost','tbb_anime','Update','El usuario: root@localhost ha actualizado un ANIME con el ID: 39 con el NOMBRE: Haibane Renmei y FECHA DE ACTUALIZACIÓN: 2023-08-17 15:40:03','2023-08-17 15:40:03',_binary ''),(42,'root@localhost','tbb_anime','Update','El usuario: root@localhost ha actualizado un ANIME con el ID: 40 con el NOMBRE: Bakemonogatari y FECHA DE ACTUALIZACIÓN: 2023-08-17 15:40:03','2023-08-17 15:40:03',_binary ''),(43,'root@localhost','tbb_anime','Update','El usuario: root@localhost ha actualizado un ANIME con el ID: 41 con el NOMBRE: Kino\'s Journey y FECHA DE ACTUALIZACIÓN: 2023-08-17 15:40:03','2023-08-17 15:40:03',_binary ''),(44,'root@localhost','tbb_anime','Update','El usuario: root@localhost ha actualizado un ANIME con el ID: 42 con el NOMBRE: Serial Experiments Lain y FECHA DE ACTUALIZACIÓN: 2023-08-17 15:40:03','2023-08-17 15:40:03',_binary ''),(45,'root@localhost','tbb_anime','Update','El usuario: root@localhost ha actualizado un ANIME con el ID: 43 con el NOMBRE: Texhnolyze y FECHA DE ACTUALIZACIÓN: 2023-08-17 15:40:03','2023-08-17 15:40:03',_binary ''),(46,'root@localhost','tbb_anime','Update','El usuario: root@localhost ha actualizado un ANIME con el ID: 44 con el NOMBRE: Kemono no Souja Erin y FECHA DE ACTUALIZACIÓN: 2023-08-17 15:40:03','2023-08-17 15:40:03',_binary ''),(47,'root@localhost','tbb_anime','Update','El usuario: root@localhost ha actualizado un ANIME con el ID: 45 con el NOMBRE: Kaiba y FECHA DE ACTUALIZACIÓN: 2023-08-17 15:40:03','2023-08-17 15:40:03',_binary ''),(48,'root@localhost','tbb_anime','Update','El usuario: root@localhost ha actualizado un ANIME con el ID: 46 con el NOMBRE: RahXephon y FECHA DE ACTUALIZACIÓN: 2023-08-17 15:40:03','2023-08-17 15:40:03',_binary ''),(49,'root@localhost','tbb_anime','Update','El usuario: root@localhost ha actualizado un ANIME con el ID: 47 con el NOMBRE: FLCL y FECHA DE ACTUALIZACIÓN: 2023-08-17 15:40:03','2023-08-17 15:40:03',_binary ''),(50,'root@localhost','tbb_anime','Update','El usuario: root@localhost ha actualizado un ANIME con el ID: 48 con el NOMBRE: Black Lagoon: Roberta\'s Blood Trail y FECHA DE ACTUALIZACIÓN: 2023-08-17 15:40:03','2023-08-17 15:40:03',_binary ''),(51,'root@localhost','tbb_anime','Update','El usuario: root@localhost ha actualizado un ANIME con el ID: 49 con el NOMBRE: Hellsing Ultimate y FECHA DE ACTUALIZACIÓN: 2023-08-17 15:40:03','2023-08-17 15:40:03',_binary ''),(52,'root@localhost','tbb_anime','Update','El usuario: root@localhost ha actualizado un ANIME con el ID: 50 con el NOMBRE: Rurouni Kenshin: Trust & Betrayal y FECHA DE ACTUALIZACIÓN: 2023-08-17 15:40:03','2023-08-17 15:40:03',_binary ''),(53,'root@localhost','tbb_anime','Update','El usuario: root@localhost ha actualizado un ANIME con el ID: 51 con el NOMBRE: Akira y FECHA DE ACTUALIZACIÓN: 2023-08-17 15:40:03','2023-08-17 15:40:03',_binary ''),(54,'root@localhost','tbb_anime','Update','El usuario: root@localhost ha actualizado un ANIME con el ID: 52 con el NOMBRE: Grave of the Fireflies y FECHA DE ACTUALIZACIÓN: 2023-08-17 15:40:03','2023-08-17 15:40:03',_binary ''),(55,'root@localhost','tbb_anime','Update','El usuario: root@localhost ha actualizado un ANIME con el ID: 53 con el NOMBRE: Princess Mononoke y FECHA DE ACTUALIZACIÓN: 2023-08-17 15:40:03','2023-08-17 15:40:03',_binary ''),(56,'root@localhost','tbb_anime','Update','El usuario: root@localhost ha actualizado un ANIME con el ID: 54 con el NOMBRE: Paprika y FECHA DE ACTUALIZACIÓN: 2023-08-17 15:40:03','2023-08-17 15:40:03',_binary ''),(57,'root@localhost','tbb_anime','Update','El usuario: root@localhost ha actualizado un ANIME con el ID: 55 con el NOMBRE: The Girl Who Leapt Through Time y FECHA DE ACTUALIZACIÓN: 2023-08-17 15:40:03','2023-08-17 15:40:03',_binary ''),(58,'root@localhost','tbb_anime','Update','El usuario: root@localhost ha actualizado un ANIME con el ID: 56 con el NOMBRE: Wolf Children y FECHA DE ACTUALIZACIÓN: 2023-08-17 15:40:03','2023-08-17 15:40:03',_binary ''),(59,'root@localhost','tbb_anime','Update','El usuario: root@localhost ha actualizado un ANIME con el ID: 57 con el NOMBRE: A Silent Voice y FECHA DE ACTUALIZACIÓN: 2023-08-17 15:40:03','2023-08-17 15:40:03',_binary ''),(60,'root@localhost','tbb_anime','Update','El usuario: root@localhost ha actualizado un ANIME con el ID: 58 con el NOMBRE: Your Name y FECHA DE ACTUALIZACIÓN: 2023-08-17 15:40:03','2023-08-17 15:40:03',_binary ''),(61,'root@localhost','tbb_anime','Update','El usuario: root@localhost ha actualizado un ANIME con el ID: 59 con el NOMBRE: Weathering with You y FECHA DE ACTUALIZACIÓN: 2023-08-17 15:40:03','2023-08-17 15:40:03',_binary ''),(62,'root@localhost','tbb_anime','Update','El usuario: root@localhost ha actualizado un ANIME con el ID: 60 con el NOMBRE: A Whisker Away y FECHA DE ACTUALIZACIÓN: 2023-08-17 15:40:03','2023-08-17 15:40:03',_binary ''),(63,'root@localhost','tbb_anime','Update','El usuario: root@localhost ha actualizado un ANIME con el ID: 61 con el NOMBRE: FLCL: Progressive y FECHA DE ACTUALIZACIÓN: 2023-08-17 15:40:03','2023-08-17 15:40:03',_binary ''),(64,'root@localhost','tbb_anime','Update','El usuario: root@localhost ha actualizado un ANIME con el ID: 62 con el NOMBRE: FLCL: Alternative y FECHA DE ACTUALIZACIÓN: 2023-08-17 15:40:03','2023-08-17 15:40:03',_binary ''),(65,'root@localhost','tbb_anime','Update','El usuario: root@localhost ha actualizado un ANIME con el ID: 63 con el NOMBRE: Tenchi Muyo! Ryo-Ohki y FECHA DE ACTUALIZACIÓN: 2023-08-17 15:40:03','2023-08-17 15:40:03',_binary ''),(66,'root@localhost','tbb_anime','Update','El usuario: root@localhost ha actualizado un ANIME con el ID: 64 con el NOMBRE: Elfen Lied y FECHA DE ACTUALIZACIÓN: 2023-08-17 15:40:03','2023-08-17 15:40:03',_binary ''),(67,'root@localhost','tbb_anime','Update','El usuario: root@localhost ha actualizado un ANIME con el ID: 65 con el NOMBRE: Gunsmith Cats y FECHA DE ACTUALIZACIÓN: 2023-08-17 15:40:03','2023-08-17 15:40:03',_binary ''),(68,'root@localhost','tbb_anime','Update','El usuario: root@localhost ha actualizado un ANIME con el ID: 66 con el NOMBRE: Macross Plus y FECHA DE ACTUALIZACIÓN: 2023-08-17 15:40:03','2023-08-17 15:40:03',_binary ''),(69,'root@localhost','tbb_anime','Update','El usuario: root@localhost ha actualizado un ANIME con el ID: 67 con el NOMBRE: Mobile Suit Gundam: The 08th MS Team y FECHA DE ACTUALIZACIÓN: 2023-08-17 15:40:03','2023-08-17 15:40:03',_binary ''),(70,'root@localhost','tbb_anime','Update','El usuario: root@localhost ha actualizado un ANIME con el ID: 68 con el NOMBRE: Hellsing: The Dawn y FECHA DE ACTUALIZACIÓN: 2023-08-17 15:40:03','2023-08-17 15:40:03',_binary ''),(71,'root@localhost','tbb_anime','Update','El usuario: root@localhost ha actualizado un ANIME con el ID: 69 con el NOMBRE: Black Rock Shooter y FECHA DE ACTUALIZACIÓN: 2023-08-17 15:40:03','2023-08-17 15:40:03',_binary ''),(72,'root@localhost','tbb_anime','Update','El usuario: root@localhost ha actualizado un ANIME con el ID: 70 con el NOMBRE: Gunbuster y FECHA DE ACTUALIZACIÓN: 2023-08-17 15:40:03','2023-08-17 15:40:03',_binary '');
/*!40000 ALTER TABLE `tbi_bitacora` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Temporary view structure for view `vw_usuarios_rating`
--

DROP TABLE IF EXISTS `vw_usuarios_rating`;
/*!50001 DROP VIEW IF EXISTS `vw_usuarios_rating`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `vw_usuarios_rating` AS SELECT 
 1 AS `Nombre usuario`,
 1 AS `Calificacion`,
 1 AS `Anime`*/;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP FUNCTION IF EXISTS `fn_recomendacion` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `fn_recomendacion`(v_id_usuario INT) RETURNS text CHARSET utf8mb3
    DETERMINISTIC
BEGIN
DECLARE v_mensaje_vistas text;
DECLARE v_mensaje_calificacion text;
DECLARE v_rnd DECIMAL(4, 2);
SET v_rnd = RAND();

    RETURN CASE
        WHEN rnd <= 0.4 THEN 'A'
        WHEN rnd <= 0.7 THEN 'B'
        WHEN rnd <= 0.85 THEN 'C'
        ELSE 'D'
    END;

RETURN concat("Te recomiendo este anime por tus previas vistas");
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
BEGIN
	DECLARE v_animes int default (SELECT count(*) FROM tbb_anime);
    DECLARE i int default 1;
...
BEGIN
    ...
    select concat("El usuario ", i) as mensaje;
        SET e = 1;
        SET v_anime_id_cantidad = FLOOR(1 + RAND() * v_anime_cantidad);
        
        WHILE e <= v_anime_id_cantidad DO
        select concat("El usuario ", i, " con una cantidad de animes de ", v_anime_id_cantidad) as mensaje;
...
BEGIN
	DECLARE v_cantidad_animes INT;
    DECLARE v_cantidad_miembros INT default (SELECT count(*) FROM tbb_miembro);
    ...
    WHILE i <= v_cantidad_miembros DO
    
		SET v_cantidad_animes = (SELECT count(*) FROM tbc_lista_animes where Miembro_id = i);
        
		SET v_pagina = v_cantidad_animes-1;
        SET e = 1;
        SET o = 0;
        
        WHILE e <= v_cantidad_animes DO
			
            SET resultado =
			(SELECT Anime_id
			FROM tbc_lista_animes
			where Miembro_id = i
			LIMIT o, 1);
			
            SET v_rating = ROUND(RAND() * 5, 2);
            
            INSERT INTO tbc_rating (`Calificacion`, `Anime_id`, `Miembro_id`) 
            VALUES (v_rating, resultado, i);
            
            select concat("El miembro=",i ," Anime id = ",resultado," ,Cantidad lista anime =", v_cantidad_animes," pagina =",o, " Con una calificacion ",v_rating) as mensaje;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_llena_base_mini` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_llena_base_mini`()
BEGIN
	call sp_inserta_usuarios(1000);
    call sp_genera_temporadas();
    call sp_genera_episodio();
    call sp_llenar_lista_animes();
    call sp_llenar_tabla_rating();
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
--
-- Final view structure for view `vw_usuarios_rating`
--
...
/*!50001 VIEW `vw_usuarios_rating` AS select `u`.`Nombre` AS `Nombre usuario`,`r`.`Calificacion` AS `Calificacion`,`a`.`Nombre` AS `Anime` from (((`tbb_usuario` `u` join `tbb_miembro` `m` on((`u`.`idUsuario` = `m`.`idMiembro`))) join `tbc_rating` `r` on((`r`.`Miembro_id` = `m`.`idMiembro`))) join `tbb_anime` `a` on((`r`.`Anime_id` = `a`.`idAnime`))) */;
...
-- Dump completed on 2023-08-17 16:00:45
